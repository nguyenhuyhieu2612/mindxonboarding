...
import { headerLinks, paths } from "@/constants";
      ...
      {isAuthenticated && (
        <div className="flex flex-1 justify-end gap-8">
          ...
          <button
            ...
            className="flex w-fit cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#39e079] text-[#122118] text-sm font-bold leading-normal tracking-[0.015em] w-full"
          >
