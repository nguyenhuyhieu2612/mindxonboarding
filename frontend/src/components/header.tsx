...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f3e7e7] px-10 py-3">
      <div className="flex items-center gap-4 text-[#1b0d0d]">
        ...
        <h2 className="text-[#1b0d0d] text-lg font-bold leading-tight tracking-[-0.015em]">
          MindX
        </h2>
      </div>
      {isAuthenticated && (
